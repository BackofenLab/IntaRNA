...
#ifndef INTARNA_PREDICTORMFE2DSEEDEXTENSIONRIBLAST_H_
#define INTARNA_PREDICTORMFE2DSEEDEXTENSIONRIBLAST_H_
...
#endif /* INTARNA_PREDICTORMFE2DSEEDEXTENSIONRIBLAST_H_ */
